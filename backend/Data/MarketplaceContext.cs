...
public class MarketplaceContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Product>().HasData(
            new Product { Id = 1, Name = "Wireless Headphones", Description = "Noise-cancelling over-ear headphones with 30-hour battery life.", Price = 149.99m, CategoryId = 1, ImageUrl = "https://placehold.co/400x300?text=Headphones", CreatedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new Product { Id = 2, Name = "Mechanical Keyboard", Description = "Compact TKL mechanical keyboard with RGB backlighting.", Price = 89.99m, CategoryId = 1, ImageUrl = "https://placehold.co/400x300?text=Keyboard", CreatedAt = new DateTime(2026, 1, 2, 0, 0, 0, DateTimeKind.Utc) },
